...
describe('Customer API Endpoints', () => {
  ...
  describe('GET /api/customers', () => {
    ...
    it('should handle database errors', async () => {
      mockStorage.getAllCustomers.mockRejectedValue(new Error('Database error'));
  ...
  describe('Customer Data Validation', () => {
    ...
    it('should handle long addresses', async () => {
      const longAddress = 'A very long address that might be typical for commercial properties or apartment complexes with detailed suite information';
